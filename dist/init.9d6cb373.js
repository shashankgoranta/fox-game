...
const getNextDieTime = clock => Math.floor(Math.random() * 3) + 2 + clock;
...
const gameState = {
  ...
  startCelebrating() {
    this.current = "CELEBRATING", (0, _UI.modFox)("celebrate");
    this.timeToStartCelebrating = -1;
  ...
  poop() {
    ...
    this.poopTime = -1;
    this.dieTime = _constants.getNextDieTime;
